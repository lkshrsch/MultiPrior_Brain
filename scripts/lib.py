...
def fullHeadSegmentation(wd, penalty_MATRIX, TPM_channel, dice_compare, dsc, model, model_name, testChannels, testLabels, subjectIndex, output_classes, segmentation_dpatch, size_minibatches,logfile, epoch, softmax_output, saveSegmentation = False):    
