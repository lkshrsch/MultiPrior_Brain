...
train_TPM_channel = '/CV_folds/aphasic_stroke/TPMs_train_set3.txt'
    
trainChannels = ['/CV_folds/aphasic_stroke/MRIs_train_set3.txt']
trainLabels = '/CV_folds/aphasic_stroke/labels_train_set3.txt'
    
validation_TPM_channel = '/CV_folds/aphasic_stroke/TPMs_validation_set3.txt'

validationChannels = ['/CV_folds/aphasic_stroke/MRIs_validation_set3.txt']
validationLabels = '/CV_folds/aphasic_stroke/labels_validation_set3.txt'
...
model = 'MultiPriors_noDownsampling' #'MultiPriors' 
