...
train_TPM_channel = '/CV_folds/aphasic_stroke/TPMs_train_set1.txt'
    
trainChannels = ['/CV_folds/aphasic_stroke/MRIs_train_set1.txt']
trainLabels = '/CV_folds/aphasic_stroke/labels_train_set1.txt'
    
validation_TPM_channel = '/CV_folds/aphasic_stroke/TPMs_validation_set1.txt'

validationChannels = ['/CV_folds/aphasic_stroke/MRIs_validation_set1.txt']
validationLabels = '/CV_folds/aphasic_stroke/labels_validation_set1.txt'
